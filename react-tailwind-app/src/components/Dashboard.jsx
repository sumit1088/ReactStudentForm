      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mt-6">
        ...
        <div className="bg-white rounded-xl p-6 shadow">
          <div className="flex items-center justify-between">
            <p className="text font-bold">Total Users</p>
        ...
        <div className="bg-white rounded-xl p-6 shadow">
          <div className="flex items-center justify-between">
            <p className="text font-bold">Total Revenue</p>
            <div className="bg-green-500 p-2 rounded-md">
              <DollarSign className="text-white w-4 h-5" />
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl p-6 shadow">
          <div className="flex items-center justify-between">
            <p className="text font-bold">Active Sessions</p>
            <div className="bg-purple-500 p-2 rounded-md">
              <TrendingUp className="text-white w-4 h-5" />
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl p-6 shadow">
          <div className="flex items-center justify-between">
            <p className="text font-bold">Analytics</p>
            <div className="bg-orange-400 p-2 rounded-md">
              <BarChart3 className="text-white w-4 h-5" />
            </div>
          </div>
